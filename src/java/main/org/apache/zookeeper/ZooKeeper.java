...
public class ZooKeeper {
    ...
    /**
     * 如果你在客户端里，不论是你自己，还是curator框架；如果需要跟zk服务器建立连接会话，都是会直接创建一个zookeeper对象实例，就代表了一个zk客户端；
     * 他底层负责跟zk服务端建立长连接，维持一个session会话；
     * 包括后续都是通过zookeeper这个东西对zk服务器发起对应的请求，以及接收响应或则向zk服务端注册watcher监听器，接收人家给你的回调通知；
     */
